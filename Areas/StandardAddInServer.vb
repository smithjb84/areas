...
Namespace Areas
    <ProgIdAttribute("Areas.StandardAddInServer"), _
...
#Region "ApplicationAddInServer Members"
        ...
        Public Sub Activate(ByVal addInSiteObject As Inventor.ApplicationAddInSite, ByVal firstTime As Boolean) Implements Inventor.ApplicationAddInServer.Activate
            Try
                ...
                m_sampleButton = Utilities.CreateButtonDefinition("Areas", "jb-areas", "", "ButtonResources\SampleButton")
            ...
            Catch ex As Exception
                MsgBox("Unexpected failure in the activation of the add-in ""Areas""" & vbCrLf & vbCrLf & ex.Message)
            End Try
        End Sub
...
#Region "User interface definition"
        ...
        Private Sub AddToUserInterface()
            ...
            Dim oPanel As RibbonPanel = toolsTab.RibbonPanels.Item("id_PanelP_ToolsMeasure")
            ' Add a button.
            ...
            ' Get the "Tools" tab.
            Dim toolsTabassy As RibbonTab = assemblyRibbon.RibbonTabs.Item("id_TabTools")
            Dim oPanelassy As RibbonPanel = toolsTabassy.RibbonPanels.Item("id_PanelA_ToolsMeasure")
            ' Add a button.
            If Not m_sampleButton Is Nothing Then
                oPanelassy.CommandControls.AddButton(m_sampleButton, True)
            End If
        End Sub
...
Public Module Globals
    ...
    Public Const g_simpleAddInClientID As String = "ed3facbf-3cad-4a98-bc1d-b0106eac52c7"
